...
<form action="../db/connect-nosotros.php" method="post">
    <label for="name">Contenido:</label>
    <input type="text" id="mision" name="mision">
    <input type="submit" value=" ¡LISTO! " class="boton">
</form>

<?php
include_once '../db/databaseadmin.php';
$query = "SELECT * FROM `imagenes` WHERE id='mision-imagen'";
    ...
    if (isset($_FILES['image'])) {
        ...
        if (empty($errores)) {
            ...
            if ($conn->connect_errno) {
                ...
                $path = "../../img/nosotros/{$nombreImagen}";
